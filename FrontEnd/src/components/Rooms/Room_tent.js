...
export default function Room_tent() {
  return (
    <div>
      <body>
        {/* <!-- head image starts --> */}
    ...
    <!-- Room starts --> */}
        ...
        <div class="container">
          <div class="row">
            <div class="col-xl-12">
              <h1 style={{ align: "center" }}>TENT ROOMS</h1>
            </div>
          </div>
        </div>
            ...
            <div class="container">
              <div class="row">
                <div class="col-xl-8">
                  ...
                  <h2>Tent Rooms</h2>
                  <p>
                    The Tent Room offers an abundance of natural light that
                    filters through large windows. These air-conditioned and
                    recently re-furbished rooms have an attached bathroom with a
                    separate shower cubicle. Each of these rooms are available
                    in plush stone and wood flooring, which adds elegance and
                    character to the decor.
                    <strong>Inclusions: Buffet Breakfast, Wi-Fi</strong>
                  </p>
                  <Link class="btn btn-primary" to="booking">Book Now</Link>
                  <br />
                  <br />
                </div>
                <div class="container">
